...
_Last updated: 2026-09-05. This document summarizes the full delivery roadmap tracked in
...
| Phase | Window | Goal |
|---|---|---|
| 0 — Project setup & research foundation | 2026-09-05 → 2026-09-12 | Project board organized, brand guide centralized, provider research structure created, first static homepage mock-up ready |
| 1 — Product definition, UX foundation & architecture | 2026-09-13 → 2026-09-27 | Data models drafted, onboarding wireframes complete, design system foundation, provider research expanded, ADR complete, MVP scope locked |
| 2 — Interactive frontend prototype | 2026-09-28 → 2026-10-18 | All 4 core screens + onboarding built against mock data, light/dark mode, internal demo |
| 3 — Backend foundation & secure-flow PoC | 2026-10-19 → 2026-11-15 | Supabase live, auth + RLS, listing lifecycle on real data, secure-transfer PoC, payment architecture decision |
| 4 — MVP transaction workflow & pilot readiness | 2026-11-16 → 2026-12-20 | End-to-end staging workflow, manual fallback, notifications, admin review, security review, pilot plan |
| 5 — Private pilot | 2027-01-04 → 2027-01-31 | Limited pilot, monitoring, feedback, fraud/dispute tracking, go/no-go decision |
| Post-MVP | after Phase 5 go/no-go | Referral integrations, social/discovery entities, badges, wallet, provider dashboards, scaling |
