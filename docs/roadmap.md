...
| 2 — Interactive frontend prototype | 2026-09-28 → 2026-10-18 | All 4 core screens + onboarding built against mock data, light/dark mode, internal demo | **Ahead of schedule.** Home, Search, Tickets, Profile all built against mock data with light/dark theming (`app/`). Event-detail page and onboarding flow still open |
